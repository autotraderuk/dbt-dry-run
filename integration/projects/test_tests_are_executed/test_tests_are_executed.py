...
def test_tests_for_missing_models_are_not_executed(dry_run_result: IntegrationTestResult):
    report = assert_report_produced(dry_run_result)
    assert "test.test_tests_are_executed.not_null_missing_model_some_column.229c1b7374" not in set(n.unique_id for n in report.nodes)