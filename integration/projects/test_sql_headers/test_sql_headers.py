...
def test_udf_column_present_and_model_runs(dry_run_result: IntegrationTestResult):
...
def test_udf_column_present(dry_run_result: IntegrationTestResult):
    node = get_report_node_by_id(dry_run_result.report,
                                 "model.test_sql_headers.sql_header_udf")
