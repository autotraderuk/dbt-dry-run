...
def test_case_invalid_unique_key_fails(dry_run_result: DryRunResult):
...
def test_case_timestamp_column_succeeds(dry_run_result: DryRunResult):
    node = get_report_node_by_id(
        dry_run_result.report,
...
def test_case_invalid_timestamp_column_fails(dry_run_result: DryRunResult):
    node = get_report_node_by_id(
        dry_run_result.report,
...
def test_case_all_succeeds(dry_run_result: DryRunResult):
    node = get_report_node_by_id(
        dry_run_result.report,
...
def test_case_single_column_succeeds(dry_run_result: DryRunResult):
    node = get_report_node_by_id(
        dry_run_result.report,
...
def test_case_invalid_column_fails(dry_run_result: DryRunResult):
    node = get_report_node_by_id(
        dry_run_result.report,
